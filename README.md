...
**Статус: ядро реализовано и принято (2026-09-21) — `PRD-001`, `SRC-001`, `INF-001`, `DB-001`, `ING-001`, `DATA-001`. Ничего не запущено, не развёрнуто и не опубликовано. Оставшиеся задачи first-10 (`FEAT-001` → `UI-001`) — `Planned`, старт только по команде владельца.**
